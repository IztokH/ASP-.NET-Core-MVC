...
SportsStore: design enhanced ASP .NET Core 2.0 MVC application for displaying lists of products, add product to the cart, show a summary of the products the customer has selected so far and remove products from cart. 
Prerequisites: Visual Studio 2017.
