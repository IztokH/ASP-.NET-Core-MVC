...
SportsStore: design enhanced ASP .NET Core 2.0 MVC application for:
a) displaying lists of products, 
b) add product to the cart,
c) show a summary of the products the customer has selected so far and
d) remove products from cart. 
Prerequisites: Visual Studio 2017.
